...
var remote_event_emitter_exports = {};
__export(remote_event_emitter_exports, {
  cleanupEventEmitter: () => cleanupEventEmitter,
  getConnectionStats: () => getConnectionStats,
  initializeEventEmitter: () => initializeEventEmitter,
  registerConnection: () => registerConnection,
  unregisterConnection: () => unregisterConnection
});
module.exports = __toCommonJS(remote_event_emitter_exports);
...
//# sourceMappingURL=remote-event-emitter.cjs.map